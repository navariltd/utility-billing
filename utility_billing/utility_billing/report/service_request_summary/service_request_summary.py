...
def get_columns():
	return [
		...
		#     "width": 120
		# },
		{"label": _("Request Status"), "fieldname": "request_status", "width": 150},
		...
		{"label": _("Properties Count"), "fieldname": "properties_count", "fieldtype": "Int", "width": 120},
		{
			"label": _("Company"),
			"fieldname": "company",
			"fieldtype": "Link",
...
def get_data(filters):
	...
	for row in data:
		row["properties_count"] = frappe.db.count(
			"Contract Utility Property Item", filters={"parent": row["name"]}
		)
...
def get_report_summary(data, filters):
	...
	for key, label in request_status_labels.items():
		if request_status_counts[key] > 0:
			summary.append(
				{"value": request_status_counts[key], "indicator": "Blue", "label": label, "datatype": "Int"}
			)

	summary.insert(0, {"value": total, "indicator": "Blue", "label": _("Total Requests"), "datatype": "Int"})
		...
		charts.append(
			{
				...
				"data": {
					...
					"datasets": [{"name": _("Number of Requests"), "values": list(status_data.values())}],
				},
				"type": "pie",
				"height": 300,
				"colors": [
		...
		charts.append(
			{
				...
				"data": {
					...
					"datasets": [{"name": _("Number of Requests"), "values": list(billing_data.values())}],
				},
				"type": "pie",
				"height": 300,
			...
			charts.append(
				{
					...
					"data": {
						"labels": months,
						"datasets": [
							{"name": _("Number of Requests"), "values": counts, "chartType": "bar"},
							{"name": _("Billed Amount"), "values": amounts, "chartType": "line"},
						],
					},
					"type": "axis-mixed",
					"height": 300,
